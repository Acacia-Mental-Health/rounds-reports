...
if (nrow(phq9gad7) != 0) {
  ...
  master_graph_plot <- ggplot(master_graph_data, aes(x = Date, y = cumulative_num_tx)) +
    ...
    scale_color_manual(values = c("#97afc9", "#d6e5f0", "#b29056", "#77928b", "#FDFD96"), na.translate = FALSE) +
    scale_fill_manual(values = c("#97afc9", "#d6e5f0", "#b29056", "#77928b","#FDFD96"), na.translate = FALSE) +
    new_scale_color() +
