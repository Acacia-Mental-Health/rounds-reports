...
tech_raw <- read.csv("../data/Tech.csv") %>% select(-"Txt.Sum", -"Email", -"Name", -"Date") %>% 
  ...
  filter(Column1 != "xx")
survey_raw <- read.csv("../data/Survey.csv") %>% select(-"Txt.Sum", -"Email", -"Name", -contains(".of.16."),
...
madrs_raw <- read.csv("../data/MADRS.csv")
